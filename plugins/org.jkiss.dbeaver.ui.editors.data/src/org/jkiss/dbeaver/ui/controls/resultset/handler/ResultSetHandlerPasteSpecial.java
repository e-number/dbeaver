...
public class ResultSetHandlerPasteSpecial extends ResultSetHandlerMain {
    ...
    private static class AdvancedPasteConfigDialog extends BaseDialog {
        ...
        private static final String PROP_INSERT_AS_SINGLE_ROW = "insertAsSingleRow";
        ...
        private Button treatMultipleRowsAsSingleCheck;
        ...
        public AdvancedPasteConfigDialog(@NotNull Shell shell) {
            ...
            if (dialogSettings.get(PROP_INSERT_AS_SINGLE_ROW) != null) {
                pasteSettings.setInsertAsSingleRow(dialogSettings.getBoolean(PROP_INSERT_AS_SINGLE_ROW));
            }
        ...
        protected Composite createDialogArea(Composite parent) {
            ...
            treatMultipleRowsAsSingleCheck = UIUtils.createCheckbox(
                composite,
                ResultSetMessages.dialog_paste_as_insert_as_single_row_text,
                ResultSetMessages.dialog_paste_as_insert_as_single_row_tip,
                pasteSettings.isInsertAsSingleRow(),
                1
            );
        ...
        protected void okPressed() {
            pasteSettings.setInsertAsSingleRow(treatMultipleRowsAsSingleCheck.getSelection());
            pasteSettings.setInsertNulls(insertNullsCheck.getSelection());
            pasteSettings.setNullValueMark(nullValueMarkCombo.getText());

            dialogSettings.put(PROP_INSERT_AS_SINGLE_ROW, pasteSettings.isInsertAsSingleRow());
