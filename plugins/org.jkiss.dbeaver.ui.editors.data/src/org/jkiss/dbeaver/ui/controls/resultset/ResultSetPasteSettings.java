...
public class ResultSetPasteSettings {
    private boolean insertAsSingleRow;
    private boolean insertNulls;
    private String nullValueMark;

    public ResultSetPasteSettings() {
        this.insertAsSingleRow = false;
        this.insertNulls = false;
        this.nullValueMark = "";
    }

    public boolean isInsertAsSingleRow() {
        return insertAsSingleRow;
    }

    public void setInsertAsSingleRow(boolean insertAsSingleRow) {
        this.insertAsSingleRow = insertAsSingleRow;
    }
